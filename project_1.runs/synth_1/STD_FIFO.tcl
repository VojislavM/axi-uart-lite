...
read_vhdl -library xil_defaultlib C:/Users/voja/psdsProject/project_1/project_1.srcs/sources_1/new/STD_FIFO.vhd
synth_design -top STD_FIFO -part xc7z020clg484-1
write_checkpoint -noxdef STD_FIFO.dcp
catch { report_utilization -file STD_FIFO_utilization_synth.rpt -pb STD_FIFO_utilization_synth.pb }
